...
from mod_tut2 import mod_tut2 as mod_tut2  # JG tutorial model, developed as concrete (without abstract)
...
def mk_mod1():  # generate the core model
    ...
    mod1 = mod_tut2()  # JG tutorial model instance (without its abstract model)
    return mod1
