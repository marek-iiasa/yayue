...
def mk_conc():
    ...
    m.ub1 = pe.Param(domain=pe.NonNegativeReals, default=10., doc='up-bnd for total activity')
    m.lb1 = pe.Param(domain=pe.NonNegativeReals, default=2., doc='lo-bnd for total activity')
    ...
    m.pz = pe.Param(domain=pe.NonNegativeReals, default=0.1, doc='price of z')
    m.ex = pe.Param(domain=pe.NonNegativeReals, default=0.1, doc='unit emission of x')
    m.ey = pe.Param(domain=pe.NonNegativeReals, default=0.5, doc='unit emission of y')
    m.ez = pe.Param(domain=pe.NonNegativeReals, default=10., doc='unit emission of z')
    ...
    m.con2 = pe.Constraint(expr=(m.lb1 <= m.x + m.y + m.z), doc='up-bnd for production level')
