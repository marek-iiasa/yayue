...
if __name__ == '__main__':
    m_name = 'iserman'     # model name (used for the dll-format file-name)
    # files
    f_data = 'dat_iserman.dat'    # data for defining the model instance
    ...
    # noinspection SpellCheckingInspection
    abst = sms_iserman.mk_sms()         # generate abstract model (SMS)
